...
var dino = new Image()
dino.src = "dino.png"
var deadDino = new Image()
deadDino.src = "deaddino.png"
...
function drawEverything() {
  ...
  // Math.floor(seconds)
  var actualTime = Math.floor(((currentTime - startTime) / 1000))
  ctx.clearRect(0, 0, 1300, 800)
  ctx.drawImage(background, 0, 0, 1300, 400)
  ctx.font = "40px Georgia"
  ctx.fillText("Score:" + actualTime, 10, 50)
  ...
  if (gameOver == true) {
    ctx.drawImage(deadDino, dinoPosition.x, dinoPosition.y, dinoPosition.width, dinoPosition.height)
  }
